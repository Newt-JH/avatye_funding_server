...
DELIMITER $$
create procedure createProject(IN categoryindex varchar(200),userDIV varchar(20),longTi varchar(30),shortTi varchar(20),susummary varchar(100),imgUrl varchar(50),serch varchar(30), content text, startData varchar(100), theEndDate varchar(100), ggoalprice Integer)
begin
        insert into
