...
function datailProject(proIndex) {
    const query =
        `select (p.nowPrice/p.goalPrice * 100) as percent,project.projectIndex,cateIndex,project.userID,longTitle,summary,profileIMG,goalPrice,beginDate,endDate,nowPrice, cateIndex, longTitle, shortTitle, summary, profileIMG, goalprice, beginDate, endDate, nowAmount, sponsor, heart, share, contents, video, webAddress, searchTag, giftIndex, gitfTitle, giftDetail, giftPrice, giftCount, giftStock, profileImage, nickName, Comment, Private, basicAddress, phone
    from project
